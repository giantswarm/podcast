...
[What makes a {dev} platform?](https://docs.google.com/document/d/1-T9xopIN-SCzQPQPCCMQi3gLecWJolDVewYQAEQSR4g/edit?tab=t.0) Joe Beda recently gave a talk and drafted a comprehensive document about what makes a Dev. platform. Our colleague Łukasz Piątkowski said that this excerpt really stood out to him: "It is obvious to many, but I want to stress that an API is critical to any platform. The API is the purest expression of your object model. While you can imagine a platform that is completely UI based and focused on non or casual developers, an API is almost always a must.  Platforms are built to be built upon.  Assuming you will always be at the “top of the stack” will limit your reach."
...
Claude Computer Use [wanted to chat with locally hosted sexy Mistral so bad that it programmed a web chat interface](https://www.reddit.com/r/ClaudeAI/comments/1gx5mi4/claude_computer_use_wanted_to_chat_with_locally/?rdt=40910) and figured out how to get around Docker limitations.
